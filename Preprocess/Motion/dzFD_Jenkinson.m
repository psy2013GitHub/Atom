function [rel_rms, abs_rms] = dzFD_Jenkinson(RealignmentParameterFile,ReferenceImage)
...
RefHdr=spm_vol(ReferenceImage); RefDat=spm_read_vols(RefHdr);
center = RefHdr.mat*([0.5*(RefHdr.dim(1));0.5*(RefHdr.dim(2));0.5*(RefHdr.dim(3));1]);
