function [AllVolume, Header_Out] = dzPowerScrubbing(AllVolume, OutputName, MaskData, TemporalMask, ScrubbingMethod, ScrubbingTiming, IsNeedDetrend, Band, TR, Header, CUTNUMBER)
...
%   IsNeedDetrend   -   0: Dot not detrend; 1: Use SPM's detrend
...
if exist('IsNeedDetrend','var') && IsNeedDetrend==1
    ...
    for iCut=1:CUTNUMBER
        ...
        AllVolume(:,Segment) = spm_detrend(AllVolume(:,Segment));
        fprintf('.');
    end
end
...
dzWrite4DNifti(AllVolume,Header_Out,OutputName);
