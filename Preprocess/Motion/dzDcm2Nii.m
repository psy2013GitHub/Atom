...
function dzDcm2Nii(OutputDir,InputFilename)

[ProgramPath, fileN, extn] = fileparts(which('Atom.m'));

%YAN Chao-Gan 120817.
if ispc
    y_Call_dcm2nii(InputFilename, OutputDir, ['-b ',ProgramPath,filesep,'dcm2nii',filesep,'dcm2nii.ini']);  %YAN Chao-Gan 130607 Changed from: y_Call_dcm2nii(InputFilename, OutputDir, 'DefaultINI');
else
